...
import com.ooyala.android.ooyalaskinsample.R;
...
public class BasicPlaybackListActivity extends Activity implements OnItemClickListener {
  private static final int LOAD_REACT_BUNDLE_PERMISSION_REQ_CODE = 0;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(com.ooyala.android.ooyalaskinsample.R.layout.list_activity_layout);
