...
public class SeekStartedNotificationHandler extends OoyalaNotificationHandler {

  public SeekStartedNotificationHandler(OoyalaPlayer player, OoyalaSkinLayoutController layoutController) {
    super(player, layoutController);
  }

  @Override
  public String getNotificationName() {
    return OoyalaPlayer.SEEK_STARTED_NOTIFICATION_NAME;
  }
